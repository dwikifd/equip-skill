  ...
  .configureOutput({
    outputError: (str, write) => {
      if (str.includes('missing required argument')) {
        ...
        console.log(`    ${chalk.cyan('npx equip-skill')} ${chalk.yellow('<source>')} ${chalk.dim('[options]')}`);
        console.log();
        console.log(chalk.dim('  Example:'));
        console.log(`    ${chalk.cyan('npx equip-skill')} ${chalk.yellow('vercel-labs/agent-skills')}`);
        console.log();
        console.log(chalk.dim('  Run') + ` ${chalk.cyan('npx equip-skill --help')} ` + chalk.dim('for more information.'));
        console.log();
      } else {
        write(str);
      }
